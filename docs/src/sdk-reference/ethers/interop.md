...
Cross-chain execution between ZKsync L2 chains: send native tokens, ERC-20 tokens, or arbitrary contract calls from a source L2 to a destination L2.
...
```ts
{{#include ../../../snippets/ethers/reference/interop.test.ts:imports}}

{{#include ../../../snippets/ethers/reference/interop.test.ts:init-sdk}}
```
...
```ts
{{#include ../../../snippets/ethers/reference/interop.test.ts:quick-start}}
```
...
```ts
{{#include ../../../snippets/ethers/reference/interop.test.ts:quote}}
```
...
```ts
{{#include ../../../snippets/ethers/reference/interop.test.ts:prepare}}
```
...
```ts
{{#include ../../../snippets/ethers/reference/interop.test.ts:handle}}
```
...
```ts
{{#include ../../../snippets/ethers/reference/interop.test.ts:status}}
```
...
```ts
{{#include ../../../snippets/ethers/reference/interop.test.ts:wait}}
```
...
```ts
{{#include ../../../snippets/ethers/reference/interop.test.ts:e2e-erc20}}
```

### Remote Contract Call

```ts
{{#include ../../../snippets/ethers/reference/interop.test.ts:e2e-call}}
```
