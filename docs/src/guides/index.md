...
This section provides **task-focused recipes** for deposits, withdrawals and interop with the adapter of your choice.

Each guide shows the minimal steps to accomplish a task using the SDK, with real code you can copy, paste, and run.

## When to use Guides

- Use these guides if you want to **get something working quickly** (e.g., deposit ETH, withdraw ERC-20, transfer tokens cross-chain via interop).
...
- [Interop with viem](./interop/viem.md)
- [Interop with ethers](./interop/ethers.md)
