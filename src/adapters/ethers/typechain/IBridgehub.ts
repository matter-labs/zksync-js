...
export interface IBridgehubInterface extends Interface {
  ...
  encodeFunctionData(
    ...
    values: [BigNumberish, BigNumberish, BigNumberish, L2MessageStruct, BytesLike[]],
  ): string;
  encodeFunctionData(
...
export namespace BridgeMintEvent {
  ...
  export type OutputTuple = [chainId: bigint, assetId: string, receiver: string, amount: bigint];
  export interface OutputObject {
    chainId: bigint;
    assetId: string;
    receiver: string;
...
export namespace MigrationFinalizedEvent {
  export type InputTuple = [chainId: BigNumberish, assetId: BytesLike, zkChain: AddressLike];
...
export namespace MigrationStartedEvent {
  ...
  export type OutputTuple = [chainId: bigint, assetId: string, settlementLayerChainId: bigint];
  export interface OutputObject {
    chainId: bigint;
    assetId: string;
...
export namespace NewChainEvent {
  ...
  export type OutputTuple = [chainId: bigint, chainTypeManager: string, chainGovernance: string];
  export interface OutputObject {
    chainId: bigint;
    chainTypeManager: string;
...
export namespace NewPendingAdminEvent {
  export type InputTuple = [oldPendingAdmin: AddressLike, newPendingAdmin: AddressLike];
...
export interface IBridgehub extends BaseContract {
  ...
  addChainTypeManager: TypedContractMethod<[_chainTypeManager: AddressLike], [void], 'nonpayable'>;

  addTokenAssetId: TypedContractMethod<[_baseTokenAssetId: BytesLike], [void], 'nonpayable'>;

  admin: TypedContractMethod<[], [string], 'view'>;

  assetIdIsRegistered: TypedContractMethod<[_baseTokenAssetId: BytesLike], [boolean], 'view'>;

  assetRouter: TypedContractMethod<[], [string], 'view'>;

  baseToken: TypedContractMethod<[_chainId: BigNumberish], [string], 'view'>;

  baseTokenAssetId: TypedContractMethod<[_chainId: BigNumberish], [string], 'view'>;
  ...
  bridgeRecoverFailedTransfer: TypedContractMethod<
    [_chainId: BigNumberish, _assetId: BytesLike, _depositSender: AddressLike, _data: BytesLike],
    [void],
    'payable'
  >;

  chainTypeManager: TypedContractMethod<[_chainId: BigNumberish], [string], 'view'>;
  ...
  ctmAssetIdFromAddress: TypedContractMethod<[_ctmAddress: AddressLike], [string], 'view'>;

  ctmAssetIdFromChainId: TypedContractMethod<[_chainId: BigNumberish], [string], 'view'>;

  ctmAssetIdToAddress: TypedContractMethod<[_assetInfo: BytesLike], [string], 'view'>;

  forwardTransactionOnGateway: TypedContractMethod<
    [_chainId: BigNumberish, _canonicalTxHash: BytesLike, _expirationTimestamp: BigNumberish],
    [void],
    'nonpayable'
  >;
  ...
  getHyperchain: TypedContractMethod<[_chainId: BigNumberish], [string], 'view'>;
  ...
  registerLegacyChain: TypedContractMethod<[_chainId: BigNumberish], [void], 'nonpayable'>;
  ...
  setAddresses: TypedContractMethod<
    [_sharedBridge: AddressLike, _l1CtmDeployer: AddressLike, _messageRoot: AddressLike],
    [void],
    'nonpayable'
  >;
  ...
  setPendingAdmin: TypedContractMethod<[_newPendingAdmin: AddressLike], [void], 'nonpayable'>;

  settlementLayer: TypedContractMethod<[_chainId: BigNumberish], [bigint], 'view'>;

  sharedBridge: TypedContractMethod<[], [string], 'view'>;

  unpauseMigration: TypedContractMethod<[], [void], 'nonpayable'>;

  whitelistedSettlementLayers: TypedContractMethod<[_chainId: BigNumberish], [boolean], 'view'>;
  ...
  ): TypedContractMethod<[_chainTypeManager: AddressLike], [void], 'nonpayable'>;
  getFunction(
  ...
  ): TypedContractMethod<[_chainId: BigNumberish, _hyperchain: AddressLike], [void], 'nonpayable'>;
  getFunction(
  ...
  ): TypedContractMethod<[_request: L2TransactionRequestDirectStruct], [string], 'payable'>;
  getFunction(
