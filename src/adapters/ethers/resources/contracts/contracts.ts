...
export function createContractsResource(client: EthersClient): ContractsResource {
    ...
    const l1 = {
        async assetId(l1Token: Address): Promise<Hex> {
            return wrapAs('CONTRACT', 'contracts.l1.assetId', async () => {
                const { l1NativeTokenVault } = await instances();
        ...
        async tokenAddress(assetId: Hex): Promise<Address> {
            return wrapAs('CONTRACT', 'contracts.l1.tokenAddress', async () => {
                const { l1NativeTokenVault } = await instances();
    ...
    const l2 = {
        ...
        async assetId(l2Token: Address): Promise<Hex> {
            return wrapAs('CONTRACT', 'contracts.l2.assetId', async () => {
                const { l2NativeTokenVault } = await instances();
        ...
        async tokenAddress(assetId: Hex): Promise<Address> {
            return wrapAs('CONTRACT', 'contracts.l2.tokenAddress', async () => {
                const { l2NativeTokenVault } = await instances();
        ...
        async originChainId(assetId: Hex): Promise<bigint> {
            return wrapAs('CONTRACT', 'contracts.l2.originChainId', async () => {
                const { l2NativeTokenVault } = await instances();
        ...
        async l2TokenAddress(l1Token: Address): Promise<Address> {
            return wrapAs('CONTRACT', 'contracts.l2.l2TokenAddress', async () => {
                const { l2NativeTokenVault } = await instances();
        ...
        async predictBridgedTokenAddress(args: { originChainId: bigint; l1Token: Address }): Promise<Address> {
            return wrapAs('CONTRACT', 'contracts.l2.predictBridgedTokenAddress', async () => {
                const { l2NativeTokenVault } = await instances();
    ...
    const router = {
        async l1TokenAddress(l2Token: Address): Promise<Address> {
            return wrapAs('CONTRACT', 'contracts.router.l1TokenAddress', async () => {
                const { l2AssetRouter } = await instances();
        ...
        async l2TokenAddress(l1Token: Address): Promise<Address> {
            return wrapAs('CONTRACT', 'contracts.router.l2TokenAddress', async () => {
                const { l2AssetRouter } = await instances();
        ...
        async assetHandlerAddress(assetId: Hex): Promise<Address> {
            return wrapAs('CONTRACT', 'contracts.router.assetHandlerAddress', async () => {
                const { l2AssetRouter } = await instances();
