const IL1InteropHandlerABI = [
    ...
    inputs: [
      {
        name: '_messageRoot',
        type: 'address',
        internalType: 'contract IMessageRootBase',
      },
    ],
  ...
  {
    type: 'error',
    name: 'InteropWithdrawalNonZeroValue',
    inputs: [
      {
        name: 'value',
        type: 'uint256',
...
export default IL1InteropHandlerABI;
