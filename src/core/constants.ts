...
export const L2_INTEROP_CENTER_ADDRESS: Address = '0x0000000000000000000000000000000000010010';

/** The address of the L2 InteropHandler contract.*/
export const L2_INTEROP_HANDLER_ADDRESS: Address = '0x000000000000000000000000000000000001000d';
