...
export namespace BridgehubDepositFinalizedEvent {
  ...
  export type OutputTuple = [chainId: bigint, txDataHash: string, l2DepositTxHash: string];
  export interface OutputObject {
    chainId: bigint;
    txDataHash: string;
...
export interface IL1AssetRouter extends BaseContract {
  ...
  setL1Erc20Bridge: TypedContractMethod<[_legacyBridge: AddressLike], [void], 'nonpayable'>;

  setNativeTokenVault: TypedContractMethod<[_nativeTokenVault: AddressLike], [void], 'nonpayable'>;
  ...
  ): TypedContractMethod<[_nativeTokenVault: AddressLike], [void], 'nonpayable'>;
  getFunction(
