...
export namespace BridgedTokenBeaconUpdatedEvent {
  ...
  export type OutputTuple = [bridgedTokenBeacon: string, bridgedTokenProxyBytecodeHash: string];
  export interface OutputObject {
...
export namespace FinalizeDepositEvent {
  ...
  export type OutputTuple = [l1Sender: string, l2Receiver: string, l2Token: string, amount: bigint];
  export interface OutputObject {
    l1Sender: string;
    l2Receiver: string;
    l2Token: string;
...
export namespace L2TokenBeaconUpdatedEvent {
  export type InputTuple = [l2TokenBeacon: AddressLike, l2TokenProxyBytecodeHash: BytesLike];
  export type OutputTuple = [l2TokenBeacon: string, l2TokenProxyBytecodeHash: string];
  export interface OutputObject {
...
export namespace WithdrawalInitiatedEvent {
  ...
  export type OutputTuple = [l2Sender: string, l1Receiver: string, l2Token: string, amount: bigint];
  export interface OutputObject {
    l2Sender: string;
    l1Receiver: string;
    l2Token: string;
...
export interface IL2NativeTokenVault extends BaseContract {
  ...
  ): TypedContractMethod<[_token: AddressLike, _originChainId: BigNumberish], [string], 'view'>;
  getFunction(
  ...
  ): TypedContractMethod<[_burnData: BytesLike, _expectedAssetId: BytesLike], [void], 'nonpayable'>;
