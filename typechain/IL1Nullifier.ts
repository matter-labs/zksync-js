...
export interface IL1Nullifier extends BaseContract {
  ...
  setL1AssetRouter: TypedContractMethod<[_l1AssetRouter: AddressLike], [void], 'nonpayable'>;
  ...
  transferTokenToNTV: TypedContractMethod<[_token: AddressLike], [void], 'nonpayable'>;
  ...
  ): TypedContractMethod<[_chainId: BigNumberish, _token: AddressLike], [bigint], 'view'>;
  getFunction(
  ...
  ): TypedContractMethod<[_chainId: BigNumberish, _token: AddressLike], [void], 'nonpayable'>;
  getFunction(
